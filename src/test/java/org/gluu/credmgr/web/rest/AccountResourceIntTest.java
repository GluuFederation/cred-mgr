...
import org.gluu.credmgr.domain.Authority;
import org.gluu.credmgr.domain.User;
import org.gluu.credmgr.repository.AuthorityRepository;
import org.gluu.credmgr.repository.UserRepository;
import org.gluu.credmgr.security.AuthoritiesConstants;
import org.gluu.credmgr.service.MailService;
import org.gluu.credmgr.service.UserService;
import org.gluu.credmgr.web.rest.dto.ManagedUserDTO;
import org.gluu.credmgr.web.rest.dto.UserDTO;
...
public class AccountResourceIntTest {
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.get().getAuthorities()).hasSize(1)
            .containsExactly(authorityRepository.findOne(AuthoritiesConstants.ADMIN));
    }
